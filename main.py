...
df = pd.read_csv('D:/Data Science project/athlete_events.csv')
region_df = pd.read_csv('noc_regions.csv')

df = preprocessor.preprocess(df,region_df)

st.sidebar.title('Olympics Analysis')
st.sidebar.image('https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/Olympic_flag.svg/255px-Olympic_flag.svg.png')
...
if user_menu == 'Country wise analysis':
    ...
    top = helper.country_wise_most_successful(df,selected_country)
...
if user_menu == 'Athlete wise analysis':
    ...
    # fig, ax = plt.subplots()
    fig = px.scatter(temp_df, x = temp_df['Weight'],y= temp_df['Height'],color= temp_df['Medal'], symbol=temp_df['Sex'] ,size_max= 60)
    st.plotly_chart(fig)
